# АСЕНА ГРУПП — лендинг и презентация
...
| Почему АСЕНА ГРУПП | Восемь причин, сюда же собраны все цифры |
...
- `logo.png` — горизонтальный замок (знак + «АСЕНА ГРУПП»), используется в шапке и подвале
...
- Компания переименована в «АСЕНА ГРУПП», но телефон и почта остались из старой
