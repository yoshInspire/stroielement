...
| Список заказчиков | блок `<ul class="trust__list">` |
...
Пути к стилям и скрипту в обеих страницах заканчиваются на `?v=4`. После правки
`style.css` или `main.js` номер нужно увеличить (`?v=5`) **в обоих файлах**,
